...
import {ViewBinding} from '../intarfaces/Binding';
import {ImgUploaderComponent} from '../components/ImgUploaderComponent/ImgUploaderComponent';
export class BookForm extends ViewBinding {
	constructor(obj) {
		super();
		...
		if(obj.hasOwnProperty('id')) {
			this.collection.selectEditableModel(obj.id);
		}
		...
		this.imgUploader = new ImgUploaderComponent('imgItem', this.lang, this.model, 'image');
